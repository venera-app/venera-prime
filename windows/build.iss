...
#define MyAppName "Venera Prime"
#define MyAppVersion "{{version}}"
#define MyAppPublisher "nyne"
#define MyAppURL "https://github.com/venera-app/venera-prime"
...
begin
  ...
  begin
    OldVersionPath := 'C:\Program Files (x86)\Venera Prime';
    if DirExists(OldVersionPath) then
    begin
      DelTree(OldVersionPath, True, True, True);
      ShortcutPath := GetEnv('USERPROFILE') + '\Desktop\Venera Prime.lnk';
      if FileExists(ShortcutPath) then
      begin
        DeleteFile(ShortcutPath);
      end;
      ShortcutPath := 'C:\Users\Public\Desktop\Venera Prime.lnk';
      if FileExists(ShortcutPath) then
      begin
        DeleteFile(ShortcutPath);
      end;
...
OutputBaseFilename=Venera-Prime-{#MyAppVersion}-windows-installer
