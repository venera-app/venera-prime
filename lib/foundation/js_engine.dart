      ...
      if (message is Map<dynamic, dynamic>) {
        ...
        switch (method) {
          ...
          case "load_setting":
            ...
            var source = ComicSource.find(key)!;
            var savedSettings = source.data["settings"];
            if (savedSettings is Map && savedSettings[settingKey] != null) {
              return savedSettings[settingKey];
            }
            var settingDefinitions = source.settings ?? const {};
            var definition = settingDefinitions[settingKey];
            if (definition != null) {
              var defaultValue = (definition as dynamic)["default"];
            ...
            Log.warning(
              "JsEngine",
              "Setting not found for comic source $key: $settingKey",
            );
            return null;
          case "isLogged":
